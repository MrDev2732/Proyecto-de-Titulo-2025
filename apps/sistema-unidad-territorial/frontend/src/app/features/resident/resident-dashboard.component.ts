								...
								<div class="space-y-3">
									...
									<button 
										...
										<div class="flex items-center">
											...
											<div>
												<div class="font-medium text-gray-900">Mis Proyectos</div>
												<div class="text-sm text-gray-500">Proponer y ver tus proyectos</div>
											</div>
										</div>
									</button>
...
export class ResidentDashboardComponent implements OnInit {
	...
	goToProjects(): void {
		this.router.navigate(['/resident-dashboard/projects']);
	}
}
